...
class sentiment_analyzer(nn.Module):
    ...
    def evaluate(self, test_dataset, threshold, device):
        """
...
def train_model(dropout = 0.0, learning_rate = 0.001, epochs = 100, threshold = 0.5):
    """
    ...
    # device = "cpu"
    model.to(device)
    report = model.evaluate(test_dataset, threshold, device)
